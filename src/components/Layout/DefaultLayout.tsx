      ...
      <AppShell.Header className="flex justify-between items-center px-4">
        ...
        <div>
          <div className="flex items-center gap-2">
            <Avatar color="cyan" radius="xl" src={'https://api.dicebear.com/7.x/identicon/svg?seed=' + ethereumAddress}></Avatar>
            <div className='flex flex-col'>
              <code className='text-sm font-semibold'>0x{ ethereumAddress?.substring(0, 12) }..</code>
