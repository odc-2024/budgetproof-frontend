        ...
        <Stack gap={20}>
          ...
          <Stack gap={5}>
            <Input.Wrapper label="Campaign Name" required>
              <Input placeholder="Enter campaign name" value={campaignName} onChange={(event) => setCampaignName(event.target.value)} />
            </Input.Wrapper>
            { /* 
            ...
            */ }
            <Input.Wrapper label="Amount" required>
              <NumberInput placeholder="Enter campaign amount" value={campaignAmount} onChange={(value) => setCampaignAmount(Number(value))} />
            </Input.Wrapper>
            <Input.Wrapper label="Unit" required>
              <Input placeholder="Enter campaign amount unit (uzs, usd etc)" value={campaignUnit} onChange={(event) => setCampaignUnit(event.target.value)} />
            </Input.Wrapper>
            { /* 
            <Select
